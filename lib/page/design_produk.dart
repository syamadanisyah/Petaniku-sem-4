...
class design_produk extends StatelessWidget {
  ...
  const design_produk({Key? key, required this.dataProduk}) : super(key: key);
...
class produk_dinamis extends StatefulWidget {
  ...
  const produk_dinamis({Key? key, required this.dataProduk}) : super(key: key);

  @override
  State<produk_dinamis> createState() =>
      _produk_dinamisState(dataProduk: dataProduk);
}

class _produk_dinamisState extends State<produk_dinamis> {
  final modelProduk dataProduk;

  _produk_dinamisState({required this.dataProduk});
