          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                height: null,
                width: 300,
                decoration: BoxDecoration(color: warna.abu_abu_hitam),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 30, top: 3),
                      child: Text(
                        '${post.luasTanah} x ${post.luasTanah}',
                        style: TextStyle(fontWeight: FontWeight.w500),
                      ),
                    ),
                    Container(
